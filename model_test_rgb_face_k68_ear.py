...
# 사용자 정의 모델 로드
model_path = 'y_eye_v2_adam_lr001.h5'  # 저장된 모델의 경로
...
while cap.isOpened():
    ...
    right_eye_indices = np.arange(36, 42)  # 36-41: Right Eye (0-based)
    left_eye_indices = np.arange(42, 48)   # 42-47: Left Eye (0-based)
    ...
    # 눈 주변 키포인트만 그리기
    eye_keypoints_indices = np.concatenate((right_eye_indices, left_eye_indices))  # 36-41, 42-47
    for idx in eye_keypoints_indices:
